...
"")
        ...
        self.pushButton_prob_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_prob_2.setMinimumSize(QtCore.QSize(100, 0))
        self.pushButton_prob_2.setObjectName("pushButton_prob_2")
        self.horizontalLayout_2.addWidget(self.pushButton_prob_2)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.pushButton_Start_monitoring = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_Start_monitoring.setObjectName("pushButton_Start_monitoring")
        self.horizontalLayout_4.addWidget(self.pushButton_Start_monitoring)
        self.pushButton_Stop_monitoring = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_Stop_monitoring.setObjectName("pushButton_Stop_monitoring")
        self.horizontalLayout_4.addWidget(self.pushButton_Stop_monitoring)
        ...
        self.horizontalLayout_16.addWidget(self.pushButton_start_test)
        self.pushButton_prob_1 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_prob_1.setObjectName("pushButton_prob_1")
        self.horizontalLayout_16.addWidget(self.pushButton_prob_1)
        self.pushButton_run_test = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_run_test.setObjectName("pushButton_run_test")
        self.horizontalLayout_16.addWidget(self.pushButton_run_test)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_value_ln_h_1.setText(_translate("MainWindow", "ln/h"))
        self.lineEdit_value_1.setText(_translate("MainWindow", "505"))
        self.lineEdit_value_ln_h_3.setText(_translate("MainWindow", "ln/h"))
        ...
        self.lineEdit_value_ln_h_2.setText(_translate("MainWindow", "ln/h"))
        self.lineEdit_value_2.setText(_translate("MainWindow", "505"))
        self.lineEdit_value_ln_h_4.setText(_translate("MainWindow", "ln/h"))
        self.pushButton_prob_2.setText(_translate("MainWindow", "Value output"))
        self.pushButton_Start_monitoring.setText(_translate("MainWindow", "Start monitoring"))
        self.pushButton_Stop_monitoring.setText(_translate("MainWindow", "Stop monitoring"))
        ...
        self.pushButton_start_test.setText(_translate("MainWindow", "Start"))
        self.pushButton_prob_1.setText(_translate("MainWindow", "Button1"))
        self.pushButton_run_test.setText(_translate("MainWindow", "Run"))
